#ifndef __WC_ICM42688_H
#define __WC_ICM42688_H
...
#define WC_ICM42688_I2C_L_ADDR 0x68 
#define WC_ICM42688_I2C_H_ADDR 0x69
#define WC_ICM42688_ID  0x47 
...
class WC_ICM42688_I2C:public WC_ICM42688{
public:
  WC_ICM42688_I2C(uint8_t i2cAddr,TwoWire *pWire=&Wire);
  /**
   * @fn begin
   * @brief Init function
   * @return Init result
...
class WC_ICM42688_SPI:public WC_ICM42688{
public:
  WC_ICM42688_SPI(uint8_t csPin=5,SPIClass *spi=&SPI);
  /**
   * @fn begin
   * @brief Init function
   * @return Init result
